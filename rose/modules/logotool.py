...
`◇───────────────◇️ ` 
    """
JOIN_ASAP = f" **🚫 Access Denied**\n\n You Must Join [My Channel](https://t.me/mahsoombotupdate)To Use Me. So, Please Join it & Try Again." 
FSUBB = InlineKeyboardMarkup( 
           [[ 
               InlineKeyboardButton(text="My Channel ", url=f"https://t.me/mahsoombotupdate") 
           ]] 
)
...
async def logo(client, message):      
 try:
        await message._client.get_chat_member(int("-1001696462918"), message.from_user.id)
...
__HELP__ = """
**Create Beautiful logos for your profile pictures from Ghost.**
